...
export default function ExitOptimizer({ mode, defs, entry, tf, appSyms, currentSl, currentTp, onApply }) {
  ...
  return (
    <div style={{ marginTop: 6 }}>
      ...
      {/* Minimum reward/risk floor + optional max-SL cap for the optimiser. */}
      <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: 14 }}>
        ...
        <label className="tap" style={{ display: "inline-flex", alignItems: "center", gap: 6, marginTop: 8, fontSize: 10.5, fontWeight: 700, color: "var(--muted)", cursor: "pointer" }}>
          Max SL
          <select value={String(maxSl)} onChange={(e) => setMaxSl(Number(e.target.value))} className="no-ring" style={{ border: "1px solid var(--line)", borderRadius: 8, padding: "4px 8px", background: "var(--elev)", color: "var(--ink)", fontWeight: 800, fontSize: 11 }}>
