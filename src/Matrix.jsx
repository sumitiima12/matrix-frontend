        ...
        <div style={{ padding: "0 18px", position: "relative", zIndex: 1 }}>
          ...
          {detail ? (
            ...
            <>
              ...
              {tab === "automation" && <Automation market={market} onRecord={recordTrade} trades={trades} strats={strats} setStrats={setStrats} onExitAll={exitAllStrategies} me={auth ? (auth.username || null) : null} isAdmin={effAdmin} userId={userId} brokerFor={brokerFor} />}
