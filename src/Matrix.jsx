        ...
        <div style={{ padding: "0 18px", position: "relative", zIndex: 1 }}>
          ...
          {detail ? (
            ...
            <>
              ...
              {tab === "ideas" && <Ideas onOpen={openStock} onBuy={buyStock} canBuy={canBuy} market={market} mode={mode} onWhy={openWhy} me={auth ? (auth.username || null) : null} isAdmin={effAdmin} adminKey={adminKey} signupAt={auth ? (auth.createdAt || null) : null} />}
